  ...
  return (
    <>
      ...
      <PageHeader
        ...
        classNames='mt-4'
      />
      <section className='text-shop-muted-text-6 space-y-6 leading-relaxed'>
        <p className='text-sm'>
          Эта Политика конфиденциальности описывает, как {SITE_NAME} («мы»,
          «наш», «нас») собирает, использует и защищает вашу личную информацию.
        </p>
        <h2 className='text-shop-primary-text mt-4 mb-3 text-xl font-semibold'>
          1. Информация, которую мы собираем
        </h2>
        <p className='text-sm'>
          Мы можем собирать следующие категории личной информации:
        </p>
        <ul className='list-disc pl-6 text-sm'>
          ...
          <li>
            Поведение при просмотре, аналитические данные и информация об
            устройстве
          </li>
          <li>
            Платежные реквизиты (обрабатываются через сторонних поставщиков)
          </li>
        </ul>
        <h2 className='text-shop-primary-text mt-4 mb-3 text-xl font-semibold'>
        ...
        <ul className='list-disc pl-6 text-sm'>
          ...
          <li>
            Улучшения функциональности веб-сайта и процесса совершения покупок
          </li>
        ...
        <p className='text-sm'>
          Мы используем файлы cookie, аналитические инструменты и подобные
          технологии для персонализации контента, анализа производительности и
