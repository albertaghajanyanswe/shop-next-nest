    ...
    <>
      ...
      <div className='space-y-6 text-sm leading-relaxed'>
        <section className='space-y-2'>
          <h2 className='text-lg font-semibold text-neutral-900'>1. Принятие условий</h2>
        ...
        <section className='space-y-2'>
          <h2 className='text-lg font-semibold text-neutral-900'>2. Ответственность пользователя</h2>
          <p className='text-neutral-700'>
        ...
        <section className='space-y-2'>
          <h2 className='text-lg font-semibold text-neutral-900'>3. Интеллектуальная собственность</h2>
          <p className='text-neutral-700'>
        ...
        <section className='space-y-2'>
          <h2 className='text-lg font-semibold text-neutral-900'>4. Объявления и сделки</h2>
          <p className='text-neutral-700'>
        ...
        <section className='space-y-2'>
          <h2 className='text-lg font-semibold text-neutral-900'>5. Запрещенные действия</h2>
