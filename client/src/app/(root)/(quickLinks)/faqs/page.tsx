...
const items = [
  { title: 'How long does shipping take?', content: '3–7 business days on average.' },
  { title: 'What is your return policy?', content: '14 days money-back guarantee.' },
  {
    title: 'What payment methods do you accept?',
    content: 'Visa, Masterp-6 rounded-xl border bg-white shadow-sm transition hover:shadow-md, PayPal, Apple Pay.',
  },
];
