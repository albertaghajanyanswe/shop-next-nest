    ...
    >
      <div className='flex items-baseline gap-2'>
        <span className='text-3xl font-semibold lg:text-4xl'>
          ${price}
          <span
            className={`text-sm font-medium ${isPopular ? 'text-neutral-700' : 'text-shop-muted-text-7'}`}
          >
            /annual
          </span>
        </span>
      ...
      {price > 0 && (
        <span
          className={`text-xs font-semibold ${isPopular ? 'text-neutral-800' : 'text-shop-light-primary'}`}
        >
