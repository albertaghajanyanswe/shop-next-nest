...
interface OrderItemDetailsModalContentProps<T extends TableSectionItem> {
...
export function OrderItemDetailsModalContent<T extends TableSectionItem>({
  orderItem,
  user,
  showConfirm = false,
  showRefund = false,
}: OrderItemDetailsModalContentProps<T>) {
